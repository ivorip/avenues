...
Properties {
    ...
    _SkinScatteringProperties ("'Skin Scattering' {Section:{126, 92, 41}}", Float) = 0
    ...
    _SssScale ("'Weight' {Min:0, Max:1}", Float) = 1
    _SssMaskCutoff ("'Mask Cutoff' {Min:0.01, Max:1}", Float) = 0.33
