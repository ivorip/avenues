...
Properties {
    ...
    // Main Textures
    _MainTextures ("'Car Paint Textures' {Section:{126, 41, 41}}", Float) = 0
    ...
    // Paint Properties 
    _PaintProperties ("'Paint' {Section:{126, 92, 41}}", Float) = 0
    ...
    // Flake Properties 
    _FlakeProperties ("'Flakes' {Section:{126, 118, 41}}", Float) = 0
