...
Properties {
    ...
    _OrientedBlendProperties ("'Directional Blend' {Section:{41, 74, 126}}", Float) = 0
    ...
    [KeywordEnum(PackedMapAlpha, BaseColorAlpha)]
    _SecondaryRoughnessSource ("'Roughness Source' {Dropdown:{PackedMapAlpha:{}, BaseColorAlpha:{_MaterialMap2,_Occlusion2}}}", Float) = 0
...
SubShader {
    ...
    Pass {
        ...
        #pragma shader_feature _DIRECTIONALBLENDMODE_OBJECT _DIRECTIONALBLENDMODE_WORLD
        #pragma shader_feature _SECONDARYROUGHNESSSOURCE_BASECOLORALPHA
