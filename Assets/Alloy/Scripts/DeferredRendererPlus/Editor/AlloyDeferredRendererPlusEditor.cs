...
[CustomEditor(typeof(AlloyDeferredRendererPlus))]
public class AlloyDeferredRendererPlusEditor : Editor
{
    ...
    public override void OnInspectorGUI() {
        ...
        if (GUI.changed) {
            var deferredRendererPlus = serializedObject.targetObject as AlloyDeferredRendererPlus;
    ...
    private void EnableTransmission() {
        foreach (AlloyDeferredRendererPlus rend in targets) {
